    ...
    <div class="flex flex-col gap-4 bg-red w-full lg:max-w-[80%] h-96">
        ...
        <div class="gap-2 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full">
            @foreach ($agendas as $agenda)
                <div class="flex flex-col justify-between gap-4 bg-white hover:shadow-md p-5 border-2 rounded-md lg:h-48 hover:scale-[102%] transition-all duration-200 cursor-pointer"
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="font-medium text-lg md:text-xl lg:text-2xl">{{ $agenda['name'] }}</h3>
                    </div>
