...
@section('title', 'kalendr | Tambah Libur')
...
@section('content')
    ...
    <div class="flex flex-col gap-4 w-full lg:max-w-[80%]">
        <div class="flex items-center gap-4 w-full">
            ...
            <h1 class="font-semibold text-xl md:text-2xl">Tambah Tanggal Libur</h1>
        </div>
        ...
        <form action="{{ route('exceptions.store') }}" method="POST"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="time" name="start_time" id="start_time" value="{{ old('start_time', '00:00') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="time" name="end_time" id="end_time" value="{{ old('end_time', '23:59') }}"
