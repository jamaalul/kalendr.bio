...
<head>
    ...
    <title>kalendr | Masuk akun</title>
...
<body class="flex bg-gray-200 p-0 md:p-1 w-screen h-screen">
    <div
        ...
        <p class="mb-8 font-medium text-gray-600 text-xl">Masuk ke Akun Kamu</p>
        <form method="POST" action="{{ route('login') }}" class="flex flex-col justify-center items-center w-full">
            @csrf
            ...
            <!-- Remember Me -->
            <div class="block mt-4 w-full md:w-[80%]">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox"
                        class="shadow-sm border-gray-300 rounded focus:ring-grey-500 text-black" name="remember">
                    <span class="ms-2 text-gray-600 text-sm">Ingat Saya</span>
                </label>
            </div>
            ...
            <div class="flex justify-end items-center mt-4 w-full md:w-[80%]">
                ...
                <button
                    class="bg-black hover:bg-gray-800 ms-3 px-5 py-2 rounded-md font-medium text-white text-sm transition-all duration-100">Log
                    in</button>
            </div>
        </form>
        ...
        <button
            class="flex justify-center items-center gap-4 hover:shadow-md mt-2 p-2 border border-gray-400 rounded-full w-full md:w-[80%] hover:scale-[102%] transition-all duration-200 cursor-pointer">
            <span
        ...
        <p class="mt-4 text-gray-400 text-sm">Belum punya akun? <a href="/register"
                class="font-medium text-black no-underline">Daftar
                sekarang</a>
        </p>
    </div>
</body>
