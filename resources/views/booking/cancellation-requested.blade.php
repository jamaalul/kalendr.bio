...
<head>
    ...
    <title>Cancellation Requested - {{ $booking->eventType->name }}</title>
...
<body class="flex justify-center items-center bg-gray-100 p-4 min-h-screen">
    ...
    <div class="bg-white p-4 md:p-8 border rounded-md w-full max-w-lg text-center">
        <div class="flex justify-center mb-6">
            <div class="flex justify-center items-center bg-blue-200 mt-3 rounded-full w-16 h-16 text-blue-600">
        ...
        <h1 class="mb-2 font-bold text-gray-900 text-2xl">Permintaan Pembatalan Dikirim</h1>
        <p class="mb-8 text-gray-600 text-sm">Permintaan pembatalan kamu sudah dikirim ke
